...
def system_scatter(coor:pd.DataFrame,**kwargs)->plt.Axes:
    ...
    #graphing
    ax = plt.figure()   
    ax = sns.scatterplot(data=coor,**kwargs,size='radius',palette='Blues',
                         edgecolor='k',linewidth=0.4)
    ax = sns.scatterplot(data=capsid,**kwargs,palette='mako',
...
def protein_scatter(coor:pd.DataFrame,**kwargs)->plt.Axes:
    ...
    #graphing
    ax = plt.figure()
    ax = sns.scatterplot(data=coor,**kwargs,size='radius', palette = 'Paired',
                         edgecolor='k',linewidth=0.4)
    ax = sns.scatterplot(data=capsid,**kwargs,palette='mako',
                         edgecolor='k',linewidth=0.6)
...
def cluster_scatter(coor:pd.DataFrame,**kwargs)->plt.Axes:
    ...
    #graphing
    ax = plt.figure()
    ax = sns.scatterplot(data=tfs[tfs.clusterID>0],**kwargs,size='radius', 
                         palette = 'viridis',hue='clusterID',
                         edgecolor='k',linewidth=0.4)
    ax = sns.scatterplot(data=capsid,**kwargs,palette='mako',
                         edgecolor='k',linewidth=0.6,hue='type')
...
def createFigures(coor:pd.DataFrame,case):
    ...
    plt.savefig(f'./figures/overview{case}.png',
                dpi=400,transparent=1,bbox_inches='tight')
    #proteins alone
    proteins = protein_scatter(coor,x='x',y='y',hue='type')
    plt.savefig(f'./figures/proteins{case}.png',
                dpi=400,transparent=1,bbox_inches='tight')
    #only clusters
    clusters = cluster_scatter(coor,x='x',y='y')
    plt.savefig(f'./figures/clusters{case}.png',
                dpi=400,transparent=1,bbox_inches='tight')
